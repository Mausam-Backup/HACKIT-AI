...
def get_user_config():
    ...
    return UserConfig(
        ...
        GROQ_API_KEY=existing_config.GROQ_API_KEY or get_groq_api_key_env(),
        GROQ_MODEL=existing_config.GROQ_MODEL or get_groq_model_env(),
...
def update_env_with_user_config():
    ...
    if user_config.GROQ_API_KEY:
        set_groq_api_key_env(user_config.GROQ_API_KEY)
    if user_config.GROQ_MODEL:
        set_groq_model_env(user_config.GROQ_MODEL)
