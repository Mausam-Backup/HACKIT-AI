...
# Simple branded success page for PitchAI authentication
SUCCESS_HTML = """<!doctype html>
<html lang="en">
<head>
  <meta charset="utf-8" />
  <meta name="viewport" content="width=device-width, initial-scale=1" />
  <title>PitchAI – Authentication successful</title>
  <style>
    :root {
...
<body>
  <main class="card">
    ...
    <p>You can now return to PitchAI to continue.</p>
...
<head>
  <meta charset="utf-8" />
  <meta name="viewport" content="width=device-width, initial-scale=1" />
  <title>PitchAI – Authentication issue</title>
  <style>
...
<body>
  <main class="card">
    ...
    <p>We’ll gently reload this page. If the issue persists, close this window and restart sign-in from PitchAI.</p>
