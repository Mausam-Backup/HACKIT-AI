...
interface PitchAISplashLoaderProps {
  message?: string;
  className?: string;
}
...
const SPLASH_MASK_SRC = "/PitchAI_Splash_v5.png";
...
export function PitchAISplashLoader({
  message = "Preparing your workspace",
  className,
}: PitchAISplashLoaderProps) {
  ...
  return (
    <main
      aria-busy="true"
      aria-label={message}
      className={cn("pitchai-splash-loader", className)}
      role="status"
