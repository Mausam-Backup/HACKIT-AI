...
function StudioTopBar({ activeStep }: { activeStep: StudioStep }) {
  return (
    <header className="pointer-events-none fixed inset-x-0 top-0 z-40 pt-28 pb-4 sm:pb-6 bg-gradient-to-b from-white via-white/80 to-white/0">
      <div className="relative mx-auto flex max-w-[1280px] 2xl:max-w-[1536px] items-center justify-between px-5 sm:px-8 2xl:px-[90px]">
        <a
          href="/dashboard"
          className="pointer-events-auto block shrink-0 group"
          aria-label="Dashboard"
        >
          <div className="relative size-[34px] 2xl:size-[44px] rounded-xl bg-gradient-to-br from-zinc-800 to-zinc-950 border border-zinc-700/50 flex items-center justify-center overflow-hidden group-hover:border-amber-500/50 group-hover:shadow-[0_0_20px_rgba(245,158,11,0.2)] transition-all duration-300 shadow-md">
...
function TemplateStudioTitle({ compact = false }: { compact?: boolean }) {
  return (
    <div
      className={`px-4 text-center ${compact ? "pt-[160px] sm:pt-[172px] 2xl:pt-[192px]" : "pt-[172px] sm:pt-[192px] 2xl:pt-[220px]"}`}
    >
    ...
    <main className="flex min-h-screen flex-col items-center bg-white font-syne">
      ...
      <div className="mt-auto w-full pb-5 2xl:pb-8 pt-12 2xl:pt-16">
        <div className="mx-auto flex max-w-[558px] 2xl:max-w-[700px] items-center gap-2 2xl:gap-3 rounded-[6px] bg-[#F4F7FB] px-3 2xl:px-4 py-2 2xl:py-2.5 text-[11px] 2xl:text-[13px] leading-tight text-[#505462]">
          ...
          <p>
            PitchAI sends each slide as a screenshot and HTML reference. Use a
...
const CustomTemplatePage = ({
  ...
  // Tailwind CDN script injection removed to prevent overriding Next.js styles
