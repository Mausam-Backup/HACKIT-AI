  ...
  return (
    <div className="px-4 w-[120px] h-full">
      <div
        ...
        `}
      >
        <div className="w-full h-full overflow-hidden slide-theme flex flex-col pb-4">
          <DndContext
            sensors={sensors}
          ...
          >
            <div
              ...
              className="overflow-y-auto w-full min-h-0 flex-1 space-y-3.5 pr-1 custom-scrollbar"
            >
              {isStreaming ? (
                presentationData &&
