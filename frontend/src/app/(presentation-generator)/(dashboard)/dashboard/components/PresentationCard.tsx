...
export const PresentationCard = ({
  ...
  const handlePreview = (e: React.MouseEvent) => {
    ...
    if (isUnsupported) {
      notify.warning(
        ...
        "This deck was created in an older PitchAI version. Downgrade to a compatible version to open it."
      );
      return;
    }
  ...
  return (
    <Card
      ...
      title={isUnsupported ? "Unsupported in this version of PitchAI" : undefined}
