  ...
  return (
    <main className="w-full">
      <div className="w-full p-5 rounded-md text-gray-900 dark:text-white">
        ...
        <Link to="/">
          <Button variant="ghost" className="w-full h-12 mt-2 text-gray-600 dark:text-gray-300 hover:text-gray-900 dark:hover:text-white hover:bg-gray-100 dark:hover:bg-white/5 rounded-lg transition-colors">
            Return to sign in
          </Button>
        </Link>
      </div>
